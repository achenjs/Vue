<template>
  <div class="signin">
    <el-form label-position="left" label-width="0px" class="demo-ruleForm login-container" auto-complete="on">
      ...
      <el-form-item>
        <el-input type="text" v-model="form.captcha" auto-complete="on" placeholder="验证码"></el-input>
      </el-form-item>
      <el-form-item>
